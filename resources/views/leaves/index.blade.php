...
<style>
    /* CSS dari file lama, dipindahkan ke @section('styles') di admin layout */
    .status-badge { padding: .3em .6em; border-radius: .25rem; font-size: 85%; font-weight: bold; color: #fff; white-space: nowrap; }
...
<h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light">Apply Leave /</span> Approval Leave
</h4>
        ...
        <div class="table-responsive text-nowrap">
            <table class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                    ...
                    @empty
                    <tr><td colspan="6" class="text-center">Tidak ada data pengajuan.</td></tr>
                    @endforelse
                </tbody>
            </table>
            <div class="mt-3">
