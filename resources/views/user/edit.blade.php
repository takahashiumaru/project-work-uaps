                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="station" class="form-select" required>
                                                <option value="Office-CGK"
                                                    {{ old('station', $user->station) == 'Office-CGK' ? 'selected' : '' }}>
                                                    Office CGK</option>
                                                <option value="CGK"
                                                    {{ old('station', $user->station) == 'CGK' ? 'selected' : '' }}>CGK
                                                </option>
                                                <option value="DPS"
                                                    {{ old('station', $user->station) == 'DPS' ? 'selected' : '' }}>DPS
                                                </option>
                                                <option value="KNO"
                                                    {{ old('station', $user->station) == 'KNO' ? 'selected' : '' }}>KNO
                                                </option>
                                                <option value="UPG"
                                                    {{ old('station', $user->station) == 'UPG' ? 'selected' : '' }}>UPG
                                                </option>
                                                <option value="SUB"
                                                    {{ old('station', $user->station) == 'SUB' ? 'selected' : '' }}>SUB
                                                </option>
                                                <option value="KJT"
                                                    {{ old('station', $user->station) == 'KJT' ? 'selected' : '' }}>KJT
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="role" class="form-select" required>
                                                ...
                                                <option value="ASS LEADER"
                                                    {{ old('role', $user->role) == 'ASS LEADER' ? 'selected' : '' }}>ASS
                                                    LEADER</option>
                                                <option value="Head Of Airport Service"
                                                    {{ old('role', $user->role) == 'Head Of Airport Service' ? 'selected' : '' }}>
                                                    Head Of Airport Service</option>
                                                <option value="DISPATCHER"
                                                    {{ old('role', $user->role) == 'DISPATCHER' ? 'selected' : '' }}>
                                                    DISPATCHER</option>
                                                <option value="DRIVER"
                                                    {{ old('role', $user->role) == 'DRIVER' ? 'selected' : '' }}>DRIVER
                                                </option>
                                                <option value="HSE"
                                                    {{ old('role', $user->role) == 'HSE' ? 'selected' : '' }}>HSE</option>
                                                <option value="LEADER"
                                                    {{ old('role', $user->role) == 'LEADER' ? 'selected' : '' }}>LEADER
                                                </option>
                                                <option value="PORTER"
                                                    {{ old('role', $user->role) == 'PORTER' ? 'selected' : '' }}>PORTER
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="manager" class="form-select" required>
                                                <option value="HAURA SHAFA AFANIN"
                                                    {{ old('manager', $user->manager) == 'HAURA SHAFA AFANIN' ? 'selected' : '' }}>
                                                    HAURA SHAFA AFANIN (24080101002)</option>
                                                <option value="TRI UTAMI RHAHAYU"
                                                    {{ old('manager', $user->manager) == 'TRI UTAMI RHAHAYU' ? 'selected' : '' }}>
                                                    TRI UTAMI RHAHAYU (24080101001)</option>
                                                <option value="SISI FADILLAH"
                                                    {{ old('manager', $user->manager) == 'SISI FADILLAH' ? 'selected' : '' }}>
                                                    SISI FADILLAH (24080101003)</option>
                                                <option value="DIMAS RAFI HADITIYO"
                                                    {{ old('manager', $user->manager) == 'DIMAS RAFI HADITIYO' ? 'selected' : '' }}>
                                                    DIMAS RAFI HADITIYO (24080101004)</option>
                                                <option value="MULYADI"
                                                    {{ old('manager', $user->manager) == 'MULYADI' ? 'selected' : '' }}>
                                                    MULYADI (102240008)</option>
                                                <option value="JUNAIDI"
                                                    {{ old('manager', $user->manager) == 'JUNAIDI' ? 'selected' : '' }}>
                                                    JUNAIDI (102240006)</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="senior_manager" class="form-select">
                                                <option value="SUBCHAN"
                                                    {{ old('senior_manager', $user->senior_manager) == 'SUBCHAN' ? 'selected' : '' }}>
                                                    SUBCHAN (507040102)</option>
                                                <option value="ADE IRWAN EFFENDI"
                                                    {{ old('senior_manager', $user->senior_manager) == 'ADE IRWAN EFFENDI' ? 'selected' : '' }}>
                                                    ADE IRWAN EFFENDI (102240243)</option>
                                            </select>
                                        </div>
