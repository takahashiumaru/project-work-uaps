            ...
            <div
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('users.apron', ['page' => $page]) }}">Daftar User</a>
                        </li>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="card bg-light border-0">
                                                <div class="card-body text-center">
                                                    ...
                                                    <h5 class="card-title">
                                                        {{ $user->join_date ? \Carbon\Carbon::parse($user->join_date)->translatedFormat('d M Y') : 'N/A' }}
                                                    </h5>
                                            ...
                                            <div class="alert alert-{{ $contractStatus }}">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        @if ($user->contract_end)
                                                            <div class="small">Berlaku hingga:
                                                                {{ \Carbon\Carbon::parse($user->contract_end)->translatedFormat('d M Y') }}
                                                            </div>
                                                        @endif
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" value="{{ $user->manager }}"
                                                    readonly>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" value="{{ $user->station }}"
                                                    readonly>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{ $user->senior_manager }}" readonly>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{ $user->join_date ? \Carbon\Carbon::parse($user->join_date)->translatedFormat('d M Y') : 'N/A' }}"
                                                    readonly>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                value="{{ $user->contract_start ? \Carbon\Carbon::parse($user->contract_start)->translatedFormat('d M Y') : 'N/A' }}"
                                                                readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                value="{{ $user->contract_end ? \Carbon\Carbon::parse($user->contract_end)->translatedFormat('d M Y') : 'N/A' }}"
                                                                readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value="{{ $user->pas_registered ? \Carbon\Carbon::parse($user->pas_registered)->translatedFormat('d M Y') : 'N/A' }}"
                                                            readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value="{{ $user->pas_expired ? \Carbon\Carbon::parse($user->pas_expired)->translatedFormat('d M Y') : 'N/A' }}"
                                                            readonly>
                                                    </div>
                                                </div>
                                            </div>
