                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="profile-info-item">
                                ...
                                <span
                                    class="info-value">{{ $user->join_date ? \Carbon\Carbon::parse($user->join_date)->format('d F Y') : 'N/A' }}</span>
                            </div>
                            <div class="profile-info-item">
                            ...
                            @if ($user->pas_expired)
                                <div class="profile-info-item">
                                    ...
                                    <span
                                        class="info-value {{ \Carbon\Carbon::parse($user->pas_expired)->isPast() ? 'text-danger' : 'text-success' }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" id="manager"
                                                value="{{ $user->manager ?? 'N/A' }}" disabled>
                                        </div>

                                        <div class="col-md-6 form-group mb-3">
                                            <label for="seniorManager">Senior Manager</label>
                                            <input type="text" class="form-control" id="seniorManager"
                                                value="{{ $user->senior_manager ?? 'N/A' }}" disabled>
                                        </div>
                                    </div>
                                    ...
                                    @if (in_array(Auth::user()->role, ['ADMIN', 'ASS LEADER', 'CHIEF', 'LEADER']))
                                        <div class="row">
                                            <div class="col-md-6 form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" id="contractStart"
                                                    value="{{ $user->contract_start ?? 'N/A' }}" disabled>
                                            </div>
                                            <div class="col-md-6 form-group mb-3">
                                                <label for="contractEnd">Contract End</label>
                                                <input type="text" class="form-control" id="contractEnd"
                                                    value="{{ $user->contract_end ?? 'N/A' }}" disabled>
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    @if (in_array(Auth::user()->role, ['Admin', 'Ass Leader', 'Chief', 'Leader', 'Finance']))
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" id="salary"
                                                value="Rp {{ $user->salary ? number_format((float) $user->salary, 0, ',', '.') : 'N/A' }}"
                                                disabled>
                                        </div>
                                    @endif
                                </form>
