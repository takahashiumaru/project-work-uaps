    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="py-4">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-1 mb-4">
                <div>
                    <h4 class="fw-bold mb-1">Manajemen Porter BGE</h4>
                    <p class="text-muted mb-0" style="font-size:0.875rem;">Informasi pegawai porter BGE PT. Angkasa Pratama Sejahtera</p>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="dt-toolbar">
                        <form action="{{ route('users.bge') }}" method="GET" class="dt-search">
