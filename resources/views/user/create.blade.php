                ...
                <div class="panel-body panel-scrollable">
                    ...
                    <form action="{{ route('users.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            <label>NIP</label>
                            <input type="text" class="form-control" name="id" placeholder="Masukkan NIP">
                        </div>
                        <div class="form-group">
                            <label>Nama</label>
                        ...
                        <div class="form-group">
                            <label>Gaji</label>
                            <input type="text" class="form-control" name="salary_display" id="salary_display" placeholder="Masukkan gaji">
